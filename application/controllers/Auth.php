...
class Auth extends CI_Controller {
	...
	private function _login()
	{
		...
		}else
		{
			...
			{
				$this->session->set_flashdata('notif','<div class="alert alert-danger col-sm-5 mx-auto" role="alert" align="center"> Maaf, Username tidak ditemukan atau password salah ! </div>');
				redirect('auth');	
			}
		}
	}
