         ...
         <div class="container">
            <div class="container-fluid">
               <div style="height: 800px; overflow: hidden; border:1px">
                  <iframe src="http://perjanjian.rskariadi.id/Admission/JadwalDokter" allowfullscreen="true"
                     frameBorder="0" width="100%" height="100%" style="position: relative;  top: -55px"></iframe>
               </div>
            </div>
         </div>
      </div>
