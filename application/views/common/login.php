...
<html lang="en">
   ...
   <body>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(<?= base_url('assets/image/kasuari.jpg') ?>); "
                  ...
                  <div class="row align-items-center">
                     <div class="col-lg-5">
                        <div class="h-100">
                           ...
                           <img
                              src="https://alexwebdevelop.com/wp-content/uploads/2019/08/php-login-and-authentication-the-definitive-guide.png"
                              alt="Image" class="img-feature img-fluid">
                        </div>
                     </div>
