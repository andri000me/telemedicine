...
<html lang="en">
   ...
   <body>
            ...
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-11 col-xl-2">
                     <h1 class="mb-0 site-logo"><a href="<?= base_url() ?>"
                        class="text-black h2 mb-0">Telemedicine</a></h1>
                  </div>
                  <div class="col-12 col-md-10 d-none d-xl-block">
                     <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                           ...
                           <li class="active"><a href="<?= base_url('guide') ?>">Panduan Pengguna</a></li>
                        </ul>
                     </nav>
                  </div>
      ...
      <div class="site-blocks-cover inner-page-cover overlay"
         style="background-image: url(<?= base_url('assets/landing/images/hero_1.jpg') ?>);" data-aos="fade"
               ...
               <div class="col-md-9">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <a href="https://wwww.facebook.com/rskariadi" class="pl-0 pr-3"><span
                           class="icon-facebook"></span></a>
                        <a href="https://wwww.twitter.com/rskariadi" class="pl-3 pr-3"><span
                           class="icon-twitter"></span></a>
                        <a href="https://wwww.instagram.com/rskariadi" class="pl-3 pr-3"><span
                           class="icon-instagram"></span></a>
                        <a href="https://wwww.youtube.com//channel/UC5PkgFKg98F7dB__gM7xq0Q" class="pl-3 pr-3"><span
