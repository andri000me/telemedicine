...
<body class="sidebar-noneoverflow">
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                     <a class="nav-link" target="_blank" href="http://www.rskariadi.co.id/page-contact.htm">Hubungi Kami</a>
                  </li>
               </ul>
            </div>
         </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-6 align-self-center order-md-0 order-1">
               <h1 class="">Panduan Pengguna</h1>
               <p class="">
                  Dapatkan Jawaban Instan Dari Pertanyaan Populer yang Ditanyakan oleh Pengguna Lain</p>
               <!-- <button class="btn" href="#start_guide">Lihat Panduan</button> -->
            </div>
   ...
   <div class="faq container" id="start_guide">
      <div class="faq-layouting layout-spacing">
         <div class="fq-comman-question-wrapper">
            <div class="row">
               <div class="col-md-12">
                  <h3>Solusi Berdasarkan Permasalahan</h3>
                  <div class="row">
                     <div class="col-md-6">
                        <ul class="">
                           <li class="list-unstyled">
                              ...
                              Bagaimana Mendapat Kode Checkin ?
                           </li>
                           <li class="list-unstyled">
                              <div class="icon-svg">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                     ...
                     <div class="card">
                        <div class="card-header" id="fqheadingOne">
                           <div class="mb-0" data-toggle="collapse" role="navigation" data-target="#fqcollapseOne" aria-expanded="false" aria-controls="fqcollapseOne">
                              ...
                              <span class="faq-q-title"> Bagaimana Mendapat Kode Checkin ?</span>
                              <div class="like-faq">
                        ...
                        <div id="fqcollapseOne" class="collapse show" aria-labelledby="fqheadingOne" data-parent="#accordionExample">
                           <div class="card-body">
                              <p>Pastikan anda sudah mendaftar online di website, telepon maupun sms dan mempunyai kode checkin. Sangat disarankan anda mendaftar online melalui website.</p>
                           </div>
                        </div>
                     </div>
                     <div class="card">
               ...
               <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
                  <div class="row justify-content-center ">
                     <div class="col-md-8 text-center">
                        ...
                        <p class="lead">Silahkan membaca petunjuk dibawah ini untuk menggunakan Telemedicine</p>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="p-3 box-with-humber">
                           ...
                           <h2>Pilih Layanan</h2>
                           <p align="justify">&emsp;&emsp;Setelah melakukan login silahkan memilih menu layanan Telemedicine, layanan yang tersedia saat ini hanya penjadwalan kemoterapi. Anda dapat menyampaikan kondisi terakhir dan keluhan anda pada menu ini. </p>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="p-3 box-with-humber">
                           ...
                           <p align="justify">&emsp;&emsp;Menu hasil kontrol dapat melihat saran atau jadwal kemoterapi anda selanjutnya. Proses penjadwalan ditentukan dengan nilai hasil laboraturium dan kondisi fisik anda melalui foto. </p>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="p-3 box-with-humber">
                           ...
                           <h2>Foto Profile</h2>
                           <p>Silahkan mengganti foto profile anda dengan foto terbaru anda, sehingga kami dapat melihat kondisi terakhir anda.</p>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="400">
                        <div class="p-3 box-with-humber">
                           ...
                           <p>Kritik dan saran anda sangat membantu kami untuk meningkatkan kualitas layanan Telemedicine RSUP Dr. Kariadi.</p>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="500">
                        <div class="p-3 box-with-humber">
                           ...
                           <p>Dalam menu panduan pengguna anda dapat mengetahui tata cara menggunakan layanan aplikasi Telemedicine RSUP Dr. Kariadi.</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
               ...
               <div class="row">
                  ...
                  <div class="col-xl-5 mx-auto col-lg-6 col-md-6 site-content-inner text-md-right text-center align-self-center">
                     <p class="mb-0"> Support by <a href="https://www.codavlo.com" class="text-success">Codavlo Indonesia</a></p>
                  </div>
               </div>
            </div>
         </div>
