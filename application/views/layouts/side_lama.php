 <ul class="navbar-nav bg-gradient-light sidebar sidebar-primary accordion" id="accordionSidebar">
     <a class="sidebar-brand d-flex align-items-center justify-content-center" target="_blank" href="<?= base_url() ?>">
         <div class="sidebar-brand-icon">
             <img class="img-profile " src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/LOGO_kariadi.jpg/200px-LOGO_kariadi.jpg" width="60%">
         </div>
     </a>
     ...
     <?php } else { ?>
         ...
         <?php if ($this->session->userdata('role') == -18) { ?>
             ...
             <li class="nav-item">
                 <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#setUser" aria-expanded="true" aria-controls="lapkas">
                     <i class="fas fa-fw fa-users"></i>
                     <span>Users</span>
                 </a>
