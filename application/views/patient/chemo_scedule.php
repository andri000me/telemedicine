<div class="card mb-5">
    ...
    <form action="<?= base_url('chemo_scedule') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label for="last_medicine" class="col-sm-5 col-form-label">Kemotherapi Terakhir</label>
                        <div class="col-sm-7">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="schedule_image" name="schedule_image" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="protocol_image" name="protocol_image" >
...
<!-- Modal -->
<div class="modal fade" id="arsiran_sample" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="https://images.unsplash.com/photo-1532153975070-2e9ab71f1b14?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80" alt="" class="img-fluid">
      </div>
...
<!-- Modal -->
<div class="modal fade" id="protocol_sample" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
